...
//   console.log('making workflow', fetchState);
  ...
  fetchState.data && fetchState.data.flow && (fetchedFlow = JSON.parse(fetchState?.data?.flow));
  fetchState.data && fetchState.data.id && !fetchState.data.flow && (fetchedFlow = {elements: initialElements});
